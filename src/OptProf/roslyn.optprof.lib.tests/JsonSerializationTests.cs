  ...
  ""assemblies"": [
    {
      ...
      ""tests"": []
        ...
        public void Serialize_AssemblyOptProfTraining_UsesCorrectPropertyNames()
        {
            ...
            var json = JsonConvert.SerializeObject(assembly);
        ...
        [Fact]
        public void RoundTrip_JsonSerializerExtensions_DeserializeMatchesJsonConvert()
        {
            const string json = @"
{
  ""products"": [
      ...
      ""tests"": [
        {
          ...
          ""testCases"": [""DDRIT.RPS.CSharp.CSharpTest.EditingAndDesigner""]
            ...
            var fromDefaultSerializer = JsonSerializer.CreateDefault().Deserialize<OptProfTrainingConfiguration>(new StringReader(json));
            var fromJsonConvert = JsonConvert.DeserializeObject<OptProfTrainingConfiguration>(json);

            Assert.Equal(fromJsonConvert.Products[0].Name, fromDefaultSerializer.Products[0].Name);
            Assert.Equal(fromJsonConvert.Products[0].Tests[0].Container, fromDefaultSerializer.Products[0].Tests[0].Container);
            Assert.Equal(fromJsonConvert.Products[0].Tests[0].TestCases[0], fromDefaultSerializer.Products[0].Tests[0].TestCases[0]);
        }
