...
namespace Roslyn.Insertion
{
    internal class CoreXT
    {
        ...
        private static Dictionary<string, (string original, JsonNode document)> ComponentFileToDocumentMap = null!;
        ...
        public static async Task<CoreXT> Load(GitHttpClient gitClient, string commitId)
        {
            ...
            ComponentFileToDocumentMap = new Dictionary<string, (string, JsonNode)>(StringComparer.OrdinalIgnoreCase);
        ...
        public bool TryGetComponentByName(string componentName, out Component? component)
        {
            ...
            (_, JsonNode? componentDocument) = GetJsonDocumentForComponent(componentName);
        ...
        private (string? original, JsonNode? document) GetJsonDocumentForComponent(string componentName)
        {
